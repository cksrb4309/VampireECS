...
[UpdateAfter(typeof(BoomerangMoveSystem))]
[UpdateAfter(typeof(SpatialPartitionBuildSystem))]
public partial struct BoomerangHitSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (transformRO, projectileRO, recentHits) in
            SystemAPI.Query<
                ...
                RefRO<BoomerangProjectileData>,
                DynamicBuffer<BoomerangRecentHitData>>())
        {
            ref readonly LocalTransform transform = ref transformRO.ValueRO;
            ref readonly BoomerangProjectileData projectile = ref projectileRO.ValueRO;
            ...
            for (int i = 0; i < candidates.Length; i++)
            {
                ...
                recentHits.Add(new BoomerangRecentHitData
                {
                    Target = candidate,
    ...
    private static bool ContainsRecentHit(DynamicBuffer<BoomerangRecentHitData> recentHits, Entity candidate)
    {
