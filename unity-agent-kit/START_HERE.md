...
- 공용 설치 규격은 [HARNESS_INSTALL_SPEC.md](C:\Users\rlack\Desktop\노션\unity-agent-kit\HARNESS_INSTALL_SPEC.md)
...
- `graphify`는 선택 사항이고 `docs/Graphify.md`가 있을 때만 구조 이해 계층으로 사용
